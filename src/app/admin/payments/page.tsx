...
const initialDepositRequests = [
    { id: 'TXN789', user: 'Player123', amount: '₹500', utr: '123456789012', screenshot: 'https://placehold.co/600x400.png', date: '2023-10-28 10:00 AM' },
    { id: 'TXN790', user: 'Lucky7', amount: '₹1000', utr: '987654321098', screenshot: 'https://placehold.co/600x400.png', date: '2023-10-28 11:30 AM' },
    { id: 'TXN791', user: 'NewUser24', amount: '₹250', utr: '555566667777', screenshot: 'https://placehold.co/600x400.png', date: '2023-10-29 09:15 AM' },
];

export default function DepositRequestsPage() {
  const [requests, setRequests] = useState(initialDepositRequests);
