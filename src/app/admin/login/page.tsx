          ...
          <CardContent>
            <div className="grid gap-4">
              <div className="grid gap-2">
                ...
                <Input id="email" type="email" placeholder="admin@example.com" defaultValue="sonickuwal@gmail.com" required />
              </div>
              <div className="grid gap-2">
                ...
                <Input id="password" type="password" defaultValue="kuwal@1234" required />
              </div>
